...
import { getEmployeeData,
    addEmployeeData,
    updateEmployeeData,
    deleteEmployeeData, } from './query';
...
export function* addEmployee({ payload}) {
    try {
        const results = yield call(addEmployeeData,payload)
...
export function* deleteEmployee({payload }) {
    try {
        const results = yield call(deleteEmployeeData,payload)
